...
#+END_SRC
  ...
  The important settings are project-related include-directory settings.
  This is a list of directory we may need while searching for head files by the compiler.
  we put them inside .clang_complete; this file is located inside the root directory 
  of the project. We use absolute path inside .clang_complete 
  =========================================
...
-I/${HOME}/work/skia/skia/include/utils
  ...
  difficulty to parse .clang_complete file
