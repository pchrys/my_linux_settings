...
noremap b : !find `pwd` -iname '*.c' -o -iname '*.cpp' -o -iname '*.cc' -o -iname '*.S'-o -iname '*.h' -o -iname '*.hh' -o -iname '*.hpp' -o -iname '*.java' -o -iname '*.js'-o -iname '*.xml' -o -iname '*.jsp' > cscope.files: !cscope -b -i cscope.files -f cscope.out: cscope reset: cscope add cscope.out
...
noremap ,n :set number!
nnoremap ,pt :set paste!
noremap ,wl :wincmd l
noremap ,wh :wincmd h
noremap ,wk :wincmd k
noremap ,wj :wincmd j
nnoremap ,sr :source ~/.vim/session.vim
nnoremap ,ss :mksession! ~/.vim/session.vim
nnoremap ,vs :source $MYVIMRC
nnoremap ,ve :vsp $MYVIMRC
nnoremap \ev :vsp $MYVIMRC
nnoremap \sv :source $MYVIMRC
nnoremap \s :mksession ~/.vim/session.vim
nnoremap \S :source ~/.vim/session.vim
noremap \wj :wincmd j
noremap \wk :wincmd k
noremap \wh :wincmd h
noremap \wl :wincmd l
...
set shortmess=aoO
badd +201 .vimrc
badd +1 work/skia/skia/src/effects/GrAlphaThresholdFragmentProcessor.fp
badd +1 work/skia/skia/src/effects/GrCircleBlurFragmentProcessor.cpp
args .vimrc
edit work/skia/skia/src/effects/GrAlphaThresholdFragmentProcessor.fp
...
exe 'vert 1resize ' . ((&columns * 31 + 98) / 196)
exe 'vert 2resize ' . ((&columns * 164 + 98) / 196)
tabedit work/skia/skia/src/effects/GrCircleBlurFragmentProcessor.cpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 30 + 98) / 196)
exe 'vert 2resize ' . ((&columns * 165 + 98) / 196)
argglobal
enew
file __Tag_List__
let s:cpo_save=&cpo
